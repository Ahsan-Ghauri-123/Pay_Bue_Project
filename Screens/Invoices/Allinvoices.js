...
const Allinvoices = (props) => {
    ...
    return (
        ...
        <View style={{ height: "13%", width: "100%", backgroundColor: "#00386D"}}>
        <View style={{ flexDirection: "row", margin: 20, gap: 10, alignItems: "center", marginTop:"10%"}}>
          <TouchableOpacity onPress={() => props.navigation.goBack()}>
            <Icons name="arrowleft" size={22} color="white" />
          </TouchableOpacity>
          <Text style={{ fontSize: 17, color: "white", flex: 1 }}>Invoices</Text>
          <TouchableOpacity style={{
            ...
            flexDirection: "row",
            alignItems: "center",
            gap: 5, borderWidth:0.5, borderColor:"white"
          }}>
